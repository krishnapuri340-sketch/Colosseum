...
import {
  LayoutDashboard, Swords, Users, UsersRound,
  Gavel, BookOpen, LogOut, Settings,
  ChevronLeft, ChevronRight, Target, Trophy, X,
} from "lucide-react";
    ...
    <Link href={href} onClick={onClick}>
      <div
        ...
        style={{
          ...
          gap:12, padding: collapsed ? "10px 0" : "9px 12px",
...
function SidebarInner({ collapsed, onClose, isMobile }:
  ...
  return (
    <div style={{
      width: isMobile ? 260 : (collapsed ? 64 : 256),
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      >
        <SidebarInner collapsed={collapsed} isMobile={false} />
      </aside>
      ...
      {mobileOpen && (
        <div className="md:hidden" style={{ position:"fixed", inset:0, zIndex:100 }}>
          ...
          <div style={{
            ...
            <SidebarInner collapsed={false} isMobile={true} onClose={closeMobile} />
          </div>
        </div>
      )}
